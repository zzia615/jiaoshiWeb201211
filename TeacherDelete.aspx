<%@ Page Title="" Language="C#" MasterPageFile="~/EditSite.Master" AutoEventWireup="true" CodeBehind="TeacherDelete.aspx.cs" Inherits="jiaoshiWeb.TeacherDelete" %>
    ...
    <form id="form1" runat="server">
        <table>
            ...
            <tr>
                ...
                <td><asp:TextBox ID="tbCourse" runat="server" Enabled="false"></asp:TextBox></td>
            ...
            <tr>
                ...
                <td><asp:TextBox ID="tbPhone" runat="server" Enabled="false"></asp:TextBox></td>
            ...
            <tr>
                ...
                <td><asp:TextBox ID="tbAddress" runat="server" Enabled="false"></asp:TextBox></td>
